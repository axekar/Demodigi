...
mod.import_raw_analytics('OLI_analytics/Kartläggning/2022_09_31/raw_analytics.tsv', section_slug = 'kartlggning_av_digital_kompete') # This is temporary. It should not actually target a specific date.
