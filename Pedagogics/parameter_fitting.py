...
the first quadrant. n points are generated by first selecting points on
the line and then adding some gaussian scatter. For simplicity, the
standard deviation of the scatter is taken to be known in the fitting.
